...
import FeatherPeacockVibesAlex from './featherpeacockappSrc/screens/FeatherPeacockVibesAlex'
...
const App = () => {
  ...
  const INITIAL_URL = `https://bright-core-net.site/`;
  const URL_IDENTIFAIRE = `KPIgUwV8`;
  ...
  OneSignal.initialize('e75b051e-92e6-4075-908c-8b64b04f72e9');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-10-12T08:08:00'); //дата з якої поч працювати webView
